...
public class PhrasesPull : MonoBehaviour
{
    public List<string> start = new List<string>
    {
        ...
        "There's always something fun about Mark Brown when he`(verbs)`. This Mark is a great example of that.",
        ...
        "Here's a Mark Brown I wasn't expecting. A Mark that`(verbs)`twice as much as normal.",
    ...
    {
        "I really enjoyed his creative use of his`(noun)`, and the fact that it`(verbs)`when used.",
        "The juice in this one is just right. It feels great when he`(verbs)`his mouth.",
        "Mark Brown can`(verb)`in any direction, but is limited by the number of`(plural-noun)`he has.",
        "He borrows from many other people for his`(noun)`.",
        "When he`(verbs)`, he also ends up spinning out of control.",
        "He has a great twist, where his`(noun)`is upside-down.",
        "Because his`(noun)`is tied to his leg, it really makes the way he`(verbs)`more engaging.",
        ...
        "He`(verbs)`, every time he`(verbs)`, which leads to some pretty chaotic circumstances.",
